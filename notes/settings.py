...
SECRET_KEY = 'django-insecure-vkrtypfs&h686cr6f9=%$jjn=$rwnb54^t5i8+-mqt!z@n8o-c'
...
# THIS BASICALLY ALLOWS ALL ORIGINS TO ACCESS THE API
# IN OUR CASE, WE ARE USING REACT TO ACCESS THE API
...
4. add CORS_ALLOW_ALL_ORIGINS = True to settings.py (this allows all origins to access the api)
"""